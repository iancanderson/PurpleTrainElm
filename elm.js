...
var _user$project$Main$stationButton = function (station) {
	return A2(
		_elm_native_ui$elm_native_ui$NativeUi_Elements$text,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$stationPicker = function (schedule) {
	return A2(
		_elm_native_ui$elm_native_ui$NativeUi_Elements$view,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$stationButton,
			_user$project$Main$stations(schedule)));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$stationPicker(schedule)
			]));
};
